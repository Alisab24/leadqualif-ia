...
export default function DevisTemplate({ 
  ...
  const validDate = new Date(Date.now() + 30 * 24 * 60 * 60 * 1000).toLocaleDateString('fr-FR', {
    day: '2-digit',
    month: '2-digit',
    year: 'numeric'
  });
  ...
  return (
    <div className="max-w-4xl mx-auto bg-white p-8 print:p-6" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <div className="grid grid-cols-2 gap-8 mb-8">
        ...
        <div>
          <div className="text-sm text-gray-500 mb-2">Date de validité</div>
          <div className="font-semibold text-gray-900">{validDate}</div>
        </div>
      </div>

      {/* Infos Client */}
      <div className="bg-gray-50 rounded-lg p-6 mb-8">
        <div className="text-sm font-semibold text-gray-700 mb-3">CLIENT</div>
      ...
      <div className="border-t border-gray-200 pt-8">
        <div className="grid grid-cols-2 gap-8">
          <div>
            <div className="text-sm text-gray-600 mb-2">Conditions de règlement</div>
