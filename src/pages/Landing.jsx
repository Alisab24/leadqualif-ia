...
const PLANS = [
  {
    ...
    features: [
      '1 utilisateur',
      '100 leads / mois',
      'Scoring IA 0–100 (chaud / tiède / froid)',
      'Formulaire de qualification public',
      'Génération factures & devis (PDF)',
      'Envoi de documents par email (PDF joint)',
  ...
  },
  {
    ...
    features: [
      ...
      'Envoi automatique par email (PDF haute qualité)',
      'Partage WhatsApp enrichi (réf., montant, lien doc)',
      'Vue liste leads avec contact WhatsApp en série',
  ...
  },
  {
    ...
    features: [
      ...
      'Leads illimités',
      'Tout le plan Agence',
      'Envoi email & WhatsApp à volume illimité',
...
const FEATURES = [
  {
    ...
    desc: 'Chaque lead est analysé et classé Chaud / Tiède / Froid avec un score précis. Contactez en priorité ceux qui sont prêts à signer.',
  },
  {
    icon: Target,
    color: 'purple',
    title: 'Pipeline Commercial',
    desc: 'Suivez chaque prospect de la prise de contact à la signature. Vue kanban, liste enrichie, alertes leads chauds.',
  },
  {
    icon: FileText,
    color: 'green',
    title: 'Documents + Envoi Email',
    desc: 'Factures, devis, contrats générés en 1 clic et envoyés automatiquement en PDF par email à votre client.',
  },
  {
    icon: MessageSquare,
    color: 'orange',
    title: 'WhatsApp en 1 Clic',
    desc: 'Envoyez un message WhatsApp pré-rempli (réf., montant, lien doc) directement depuis la liste de leads. Contact en série pour relancer toute une liste.',
  },
  {
    icon: Users,
    color: 'pink',
    title: 'Gestion d\'équipe',
    desc: 'Invitez vos collaborateurs. Chacun voit les leads et documents de l\'agence. Historique CRM partagé.',
  },
  {
    icon: Sparkles,
    color: 'yellow',
...
const FAQ = [
  ...
  {
    q: 'L\'envoi de documents par email est-il inclus dans mon abonnement ?',
    a: 'Oui. L\'envoi d\'emails avec PDF joint est inclus dans tous les plans payants. Les envois passent par nos partenaires Resend (email) et pdfshift.io (génération PDF) — les crédits sont mutualisés et transparents pour vous. En cas de dépassement des quotas partenaires, nous vous prévenons par email.',
  },
  {
